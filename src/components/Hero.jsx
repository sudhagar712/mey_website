...
const Hero = () => {
  return (
    <div className="min-h-screen ">
      <motion.section
        className="relative bg-[#fec000] h-[350px] md:h-[800px] lg:h-[560px] xl:h-[500px] px-6 md:px-12 lg:px-24 flex flex-col items-center justify-center overflow-hidden"
        initial={{ opacity: 0 }}
        animate={{ opacity: 1 }}
      ...
      >
        ...
        />
        <p className="text-xl md:text-5xl  lg:text-3xl xl:text-3xl text-black/80  md:mt-10 lg:mt-0   leading-[1.6] mb-8 md:mb-10 lg:mb-5">
          We build{" "}
