            ...
            <section className="relative min-h-[100vh] flex flex-col items-center justify-center pt-32 pb-16 px-6 md:px-12 overflow-hidden bg-[#ffff00]">
                ...
                <div className="relative z-10 max-w-[1400px] w-full mx-auto flex flex-col items-center text-center mt-[-6vh]">
                    ...
                    <div className="relative mb-24 w-full flex flex-col items-center justify-center">
                        ...
                        <h1 className="text-[150px] sm:text-[240px] md:text-[320px] lg:text-[400px] leading-[0.75] font-premium-serif font-bold tracking-tighter text-black select-none z-0">
                            MEY
                        </h1>
                    ...
                    <div className="flex flex-col items-center max-w-4xl mx-auto">
                        ...
                        <div className="flex items-center gap-6 mb-10 w-full justify-center">
                            ...
                            <h2 className="text-[10px] md:text-xs font-bold uppercase tracking-[0.3em] text-black/80 text-center" style={{ fontFamily: 'Poppins, sans-serif' }}>
                        ...
                        <div className="flex flex-col sm:flex-row gap-6 w-full sm:w-auto">
                            ...
                            >
                                <div className="absolute inset-0 w-full h-full bg-[#ffff00] translate-y-[100%] group-hover:translate-y-0 transition-transform duration-500 -z-10 ease-out"></div>
                                View Work
