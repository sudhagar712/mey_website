        ...
        <section className="relative w-full py-24 md:py-32 bg-white text-[#111] overflow-hidden border-t border-gray-100 shadow-sm">
            ...
            <div className="relative z-10 max-w-[1300px] mx-auto px-6 md:px-12 grid grid-cols-1 lg:grid-cols-2 gap-16 lg:gap-24 items-center">
                ...
                >
                    ...
                    <h2 className="text-4xl md:text-5xl lg:text-6xl font-light mb-8 leading-tight md:leading-[1.1] tracking-tight text-gray-900">
                        We don’t begin with design or marketing. <br className="hidden lg:block" />
                        <span className="font-extrabold text-[#111] block mt-2 lg:mt-4">We begin with understanding.</span>
                    </h2>

                    <div className="w-20 h-[2px] bg-gray-200 mb-8" />

                    <p className="text-gray-600 text-lg md:text-xl font-light leading-relaxed mb-6">
                        We look at what the brand truly represents, what it can own in the market, and why it deserves to be chosen. This clarity becomes the foundation on which everything else is built.
                    </p>
                    <p className="text-gray-800 text-lg md:text-xl font-medium leading-relaxed">
                        Across different industries and stages of growth, this approach has consistently shifted brands from being noticed to <span className="text-yellow-600 font-bold">being preferred.</span>
                    </p>
                </motion.div>
                ...
                <motion.div
                    ...
                    className="relative w-full aspect-square md:aspect-[4/3] rounded-[2rem] overflow-hidden group shadow-2xl ring-1 ring-gray-900/5 bg-gray-100"
                >
                    ...
                    <video
                        ...
                        muted
                        playsInline
                        className="absolute inset-0 w-full h-full object-cover z-10 transition-transform duration-[3s] ease-out group-hover:scale-105"
