...
const WeOperate = () => {
  ...
  return (
    <section
      ref={containerRef}
      className="relative py-32 bg-black overflow-hidden text-neutral-300"
    >
      {/* subtle grid */}
        ...
        <div className="flex flex-col lg:flex-row justify-between items-start gap-16 lg:gap-24">
          ...
          >
            ...
            <div className="flex items-center gap-4 mb-8">
              ...
              <span className="text-md font-bold tracking-[0.4em] uppercase text-[#f1bd40]">
               the mey method
              </span>
            </div>
          ...
          >
            <div className="relative p-8 md:p-12 lg:p-14 bg-white/[0.02] border border-white/[0.05] rounded-3xl backdrop-blur-md shadow-2xl group">
              ...
              <div className="relative z-10">
                ...
                <p className="text-[14px] md:text-[16px] font-light text-neutral-300 leading-relaxed md:leading-[1.8]">
                  We question assumptions, remove what weakens the brand, and
                  build what strengthens it. From early-stage ventures finding
                  direction to established businesses redefining their position,
                  ...
                  <span className="font-medium text-white group-hover:text-yellow-400 transition-colors duration-500">
                    ensuring that branding decisions directly contribute to
                    business outcomes.
                  </span>
                </p>
              </div>
